    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "VueFormError", link: "/components/error" },
          { text: "VueFormCreate", link: "/components/create" },
          { text: "VueFormUpdate", link: "/components/update" },
          { text: "VueFormDelete", link: "/components/delete" },
          { text: "VueFormArchive", link: "/components/archive" },
          { text: "VueFormUnarchive", link: "/components/unarchive" },
        ],
      },
    ],
    search: {
