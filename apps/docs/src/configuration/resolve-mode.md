...
- Returns `CREATE`: Form enters create mode. No API call is made; default field values are used.
- Returns `UPDATE`: Form enters edit mode. The `read` function is called with `itemId` to fetch existing data.
