...
/* harmony default export */ var src_options = ({
  componentPrefix: "V",
  errorAdapter: function errorAdapter(errors) {
    return errors;
...
var warn = function warn(message, value) {
...
/* harmony default export */ var FormRootvue_type_script_lang_js_ = ({
  props: {
    /**
     * Possible config
  ...
  computed: {
     ...
     */
    serializedFields: function serializedFields() {
      return this.fields.map(function (field, index) {
        var fieldType = _typeof(field);

        if (fieldType === "string") {
          return _objectSpread2(_objectSpread2({}, defaultFieldConfig), {}, {
            name: field,
            value: null
          });
        } else if (fieldType === "object" && !Array.isArray(field)) {
          return _objectSpread2(_objectSpread2({}, defaultFieldConfig), field);
        } else {
        ...
        return item;
      }); // Removes invalid field configs
    },
    fieldErrors: function fieldErrors() {
      var _this = this;

      return Object.keys(this.errors).filter(function (name) {
        return _this.hasField(name);
      }).reduce(function (result, name) {
        result[name] = _this.errors[name];
        return result;
      }, {});
    },
    nonFieldErrors: function nonFieldErrors() {
      var _this2 = this;

      return Object.keys(this.errors).filter(function (name) {
        return !_this2.hasField(name);
      }).reduce(function (result, name) {
        result[name] = _this2.errors[name];
        return result;
      }, {});
    },
    values: function values() {
      ...
      var res = {};
      this.serializedFields.forEach(function (field) {
        res[field.name] = field.out(_this3.state[field.name]);
      });
      return res;
    },
    mode: function mode() {
  ...
  methods: {
    ...
    hasField: function hasField(name) {
      return this.serializedFields.find(function (field) {
    ...
    setState: function setState() {
      ...
      this.$set(this, "state", state); // Sync the state with parent component
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this4.isGetting = true;

                _this4.setErrors();

                _this4.get(_this4.id).then(function (res) {
                  if (_this4.validateIn(res)) {
                    _this4.setState(res);
                  }
                }).catch(function (err) {
                  _this4.setErrors(err);
                }).finally(function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this5.save(_this5.id, lodash_es_cloneDeep(_this5.values)).then(function (res) {
                  if (_this5.validateIn(res)) {
                    _this5.setState(res);
                  }
                }).catch(function (err) {
                  _this5.setErrors(err);
                }).finally(function () {
    ...
    setErrors: function setErrors(errors) {
      if (errors) {
        var _this$OPTIONS$errorAd = this.OPTIONS.errorAdapter(errors),
            fields = _this$OPTIONS$errorAd.fields,
            message = _this$OPTIONS$errorAd.message;
    ...
    validateIn: function validateIn(res) {
      if (_typeof(res) !== "object" || Array.isArray(res)) {
...
;// CONCATENATED MODULE: ./src/components/FormRoot.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_FormRootvue_type_script_lang_js_ = (FormRootvue_type_script_lang_js_); 
...
;// CONCATENATED MODULE: ./src/components/FormRoot.vue
...
var component = normalizeComponent(
  components_FormRootvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var FormRoot = (component.exports);
...
var install = function install(Vue) {
  ...
  var options = Object.assign({}, src_options, userOptions);
  var prefix = options.componentPrefix; //Root Component

  Vue.component("".concat(prefix, "Form"), {
    data: function data() {
      return {
        OPTIONS: options
      };
